...
class _CurrencySettingsPageState extends State<CurrencySettingsPage>
  ...
  List<Currency> get _filteredCurrencies {
    ...
    return CurrencyService.supportedCurrencies.where((currency) =>
        currency.name.toLowerCase().contains(_searchQuery.toLowerCase()) ||
        currency.code.toLowerCase().contains(_searchQuery.toLowerCase())).toList();
  }
              ...
              children: [
                ...
                Expanded(
                  child: _buildPreviewItem(
                    ...
                    Icons.decimal_increase_outlined,
                  ),
                ),
              ],
            ),

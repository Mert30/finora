...
class _AddCardPageState extends State<AddCardPage> 
  ...
  String _maskCardNumber(String cardNumber) {
    ...
    final masked = '**** **** **** ${cleanNumber.substring(cleanNumber.length - 4)}';
    return masked;
  }
  ...
  Future<void> _saveCard() async {
    ...
    try {
      ...
      final cardId = FirebaseFirestore.instance.collection('users').doc(userId).collection('cards').doc().id;
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              hint: Row(
                children: [
                  const Icon(Icons.account_balance, color: Color(0xFF6B7280), size: 20),
                  const SizedBox(width: 12),
                  Text(
                    'Bankayı seçiniz',
                    style: GoogleFonts.inter(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 12,
          runSpacing: 12,
          children: _cardColors.map((color) => GestureDetector(

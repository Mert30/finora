import 'package:finora_app/features/goals/presentation/add_goals_page.dart';
...
class _BudgetGoalsPageState extends State<BudgetGoalsPage>
  ...
  Widget _buildSummarySection() {
    ...
    final totalTargetAmount = _goals.fold(
      0.0,
      (sum, goal) => sum + goal.targetAmount,
    );
    final totalCurrentAmount = _goals.fold(
      0.0,
            ...
            children: [
              ...
              Expanded(
                child: _buildStatCard(
                  ...
                  value:
                      '${(_goals.fold(0.0, (sum, goal) => sum + goal.progress) / _goals.length * 100).toStringAsFixed(0)}%',

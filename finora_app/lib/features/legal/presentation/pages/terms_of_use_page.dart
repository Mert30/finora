      ...
      child: Column(
        ...
        children: [
          ...
          _buildTermsSection(
            '1. Hizmet Tanımı',
            [
              'Finora, kişisel finans yönetimi için tasarlanmış bir mobil uygulamadır.',
          ...
          _buildTermsSection(
            ...
            [
              ...
              'Ödeme app store üzerinden güvenli şekilde alınır.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Finora uygulamasını kullanarak aşağıdaki kullanım koşullarını kabul etmiş olursunuz. Lütfen dikkatlice okuyunuz.',
            style: GoogleFonts.inter(
              color: Colors.white.withOpacity(0.9),
              fontSize: 16,
              fontWeight: FontWeight.w500,

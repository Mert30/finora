      ...
      child: Column(
        ...
        children: [
          ...
          _buildPrivacySection(
            ...
            Icons.collection_bookmark_outlined,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Finora olarak kişisel verilerinizin korunmasını en üst düzeyde önemsiyoruz. Bu politika, verilerinizin nasıl toplandığını, kullanıldığını ve korunduğunu açıklar.',
            style: GoogleFonts.inter(
              color: Colors.white.withOpacity(0.9),
              fontSize: 16,
              fontWeight: FontWeight.w500,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            '© 2024 Finora. Gizliliğinizi korumak için taahhüt ediyoruz.',
            style: GoogleFonts.inter(

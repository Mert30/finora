...
class _AddGoalPageState extends State<AddGoalPage>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          _buildSectionHeader('Tutar ve Süre', Icons.account_balance_wallet_outlined),
          const SizedBox(height: 20),
          _buildTextField(
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(8),
                              border: isSelected 
                                  ? Border.all(color: const Color(0xFF1F2937), width: 2)
  ...
  Future<void> _saveGoal() async {
    ...
    final monthlyContribution = _monthlyContributionController.text.trim().isEmpty
        ? 0.0

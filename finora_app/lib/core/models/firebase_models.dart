...
class FirebaseTransaction {
  ...
  // Firestore'dan okumak için
  factory FirebaseTransaction.fromFirestore(
...
class FirebaseBudgetGoal {
  ...
  // Firestore'dan okumak için
  factory FirebaseBudgetGoal.fromFirestore(
    DocumentSnapshot doc,
    String userId,
  ) {
    final data = doc.data() as Map<String, dynamic>;
...
class FirebaseCategoryModel {
  ...
  // Firestore'dan okumak için
  factory FirebaseCategoryModel.fromFirestore(
    DocumentSnapshot doc,
    String userId,
  ) {
    final data = doc.data() as Map<String, dynamic>;
...
class NotificationSettings {
  ...
  static bool get hasActiveNotifications {
    return _globalBudgetAlerts ||
        _globalSavingTips ||
        _globalGoalUpdates ||
        _globalBillReminders ||
        _globalDailySummary;
  }

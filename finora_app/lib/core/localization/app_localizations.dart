...
class AppLocalizations {
  ...
  // Messages
  String get transactionAddedSuccessfully => _getValue('transaction_added_successfully');
  String get transactionDeletedSuccessfully => _getValue('transaction_deleted_successfully');
  ...
  // Help Center
  String get frequentlyAskedQuestions => _getValue('frequently_asked_questions');
